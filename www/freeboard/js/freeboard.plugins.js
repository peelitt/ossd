...
(function()
{
	...
	freeboard.addStyle('.rag-light', "border-radius:50%;width:30px;height:30px;border:2px solid #3d3d3d;margin-top:5px;float:left;background-color:#222;margin-right:20px;");
